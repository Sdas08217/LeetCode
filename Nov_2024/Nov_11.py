...
# Test case 1: List that can be made strictly increasing by subtracting prime numbers
nums1 = [4, 9, 6]
result1 = solution.primeSubOperation(nums1)
print(f"Can the array {nums1} be made strictly increasing by subtracting prime numbers? {result1}")

# Test case 2: List that cannot be made strictly increasing
nums2 = [5, 4, 3]
result2 = solution.primeSubOperation(nums2)
print(f"Can the array {nums2} be made strictly increasing by subtracting prime numbers? {result2}")
